...
const nextConfig = {
  ...
  async headers() {
    ...
    const cspParts = [
      ...
      `frame-src 'self' https://www.mercadopago.com https://www.mercadolibre.com https://http2.mlstatic.com https://www.google.com ${supabaseDomain !== 'https://*.supabase.co' ? supabaseDomain : 'https://*.supabase.co'}`,
