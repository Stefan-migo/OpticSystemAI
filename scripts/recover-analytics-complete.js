...
const BACKUP_DIR = path.join(PROJECT_ROOT, '.analytics-recovery-backup');
...
// Archivos críticos de Analíticas
...
// API Routes relacionadas con Analíticas
...
// Migraciones relacionadas con Analíticas
const ANALYTICS_MIGRATIONS = [
  // Ya verificamos que existe 20251222000000_add_branch_to_support_and_analytics.sql
];
...
function main() {
  console.log('🔄 Recuperación Completa de Sección de Analíticas');
  ...
  // Recuperar API routes faltantes
  console.log('\n📁 Recuperando API routes faltantes...');
  ANALYTICS_API_ROUTES.forEach(routePath => {
  ...
  ANALYTICS_MIGRATIONS.forEach(migrationPath => {
