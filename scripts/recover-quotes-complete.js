...
const BACKUP_DIR = path.join(PROJECT_ROOT, '.quotes-recovery-backup');
...
// Archivos críticos de Presupuestos
...
// Migraciones relacionadas con Presupuestos
const QUOTE_MIGRATIONS = [
...
function main() {
  console.log('🔄 Recuperación Completa de Sección de Presupuestos');
  ...
  QUOTE_MIGRATIONS.forEach(migrationPath => {
