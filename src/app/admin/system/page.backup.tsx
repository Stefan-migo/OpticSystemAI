            ...
            <CardContent>
              {loadingBackups ? (
                ...
                <div className="text-center py-8">
                  ...
                  <p className="text-xs text-tierra-media">
                    Crea un backup usando el botón &quot;Backup Base de
                    Datos&quot;
                  </p>
                </div>
              ) : (
                                ...
                                <div className="mt-2 ml-6 space-y-1">
                                  ...
                                  {result.problematic_records.map(
                                    (pr: any, idx: number) => (
                                      <div
                                        key={idx}
                                        className="text-xs text-red-600 dark:text-red-400 bg-red-50 dark:bg-red-900/20 p-2 rounded border border-red-200 dark:border-red-800"
                                      >
