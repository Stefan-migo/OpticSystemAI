...
export async function GET(request: NextRequest) {
  try {
    ...
    if (error) {
      console.error('Error fetching product option fields:', error);
    ...
    console.error('Error in GET /api/admin/product-options:', error);
    return NextResponse.json(
...
export async function POST(request: NextRequest) {
  try {
    ...
    if (type === 'field') {
      ...
      if (error) {
        console.error('Error creating option field:', error);
        return NextResponse.json(
    ...
    console.error('Error in POST /api/admin/product-options:', error);
    return NextResponse.json(
      { error: 'Error interno del servidor' },
      { status: 500 }
    );
...
export async function PUT(request: NextRequest) {
  try {
    ...
    if (type === 'field') {
      ...
      if (error) {
        console.error('Error updating option field:', error);
        return NextResponse.json(
    ...
    console.error('Error in PUT /api/admin/product-options:', error);
    return NextResponse.json(
      { error: 'Error interno del servidor' },
      { status: 500 }
    );
...
export async function DELETE(request: NextRequest) {
  try {
    ...
    if (type === 'value') {
      ...
      if (error) {
        console.error('Error deleting option field:', error);
        return NextResponse.json(
    ...
    console.error('Error in DELETE /api/admin/product-options:', error);
    return NextResponse.json(
      { error: 'Error interno del servidor' },
      { status: 500 }
    );
