...
export async function POST(request: NextRequest) {
  try {
    ...
    const migrationPath = path.join(process.cwd(), 'supabase', 'migrations', '20250129000000_add_optical_notification_types.sql');
    ...
    return NextResponse.json({
      message: 'Migration SQL prepared. Please execute manually in Supabase Studio.',
      sql: migrationSQL,
      instructions: [
