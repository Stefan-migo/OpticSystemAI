...
export function getAIConfig(): AIConfig {
  return {
    ...
    defaultProvider: (process.env.AI_DEFAULT_PROVIDER as LLMProvider) || 'deepseek',
    defaultModel: process.env.AI_DEFAULT_MODEL || 'deepseek-chat',
    fallbackProviders: (process.env.AI_FALLBACK_PROVIDERS?.split(',') as LLMProvider[]) || ['google', 'openai'],
    providers: {
      openai: {
